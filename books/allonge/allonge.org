...
*** TODO but every expression evaluates to a value?
** values and identity
...
** Method Decorators
   ...
   function.
*** TODO a-contextual function decorator Example:
...
*** TODO memo and fibonacci Example:
...
*** TODO memoizing recursive functions (ackward language, functional expressions?)
