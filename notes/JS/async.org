...
** Promises
Promises represent future values. They allow you to retain control over the callback, by allowing you to execute your callbacks upon "completion events."
You control over what happens when a requested value arrives, solving the inversion of control problem inherent with vanilla callbacks.
...
*** Native Promise API
In native promises, the completion event is the .then method.
