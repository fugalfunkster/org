...
*** DONE RESTful Web Services with Node.js and Express


*** DONE Building Web Applications with node.js and Express 4.0
...
*** DONE Javascript Objects and Prototypes
...
**** statements
***** all expressions are statements - but return undefined when applied
***** Ex: () => {2 + 2} >> [function]
***** Ex: (() => {2+2})() >> undefined
...
*** Magic Names
**** this
***** bound to the function's context
**** arguments
...
***** The distinction helps sort out the syntatix differences re: magic words
