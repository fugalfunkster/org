...
=======
*** FreeCodeCamp BackEnd Projects [0/2]
**** TODO Book Sharing App
**** TODO Pinterest Clone
*** Pluralsight Courses [0/6]
    - [ ] React.js: Getting Started : Samer Buna (1:29)
    - [ ] JavaScript Design Patterns : Aaron Powell (2:03)
    - [ ] Using the Chrome Developer Tools : John Sonmez (2:50)
    - [ ] Docker Deep Dive : Nigel Poulton (5:38)
    - [ ] Node Application Patterns : Rob Conery (2:31)
    - [ ] Node.js Testing Strategies : Rob Conery (2:39)
>>>>>>> 04f0c6c657a69463e858ed780d5fe6067cf0c2f9
*** JavaScript Allonge [0/3]
**** TODO Review First Half
**** TODO Served by the Pot: Collections
**** TODO A coffeehouse: symbols
*** Tools [0/4]
**** TODO React
**** TODO docker
***** docker.el?
...
**** TODO jump around?
*** JavaScript on the High Seas [0/3]
**** TODO Outline
**** TODO Intro
**** TODO Syntax
*** Revisit Udemy Node Course
<<<<<<< HEAD
...
***** JS
     ...
     - [X] JavaScript Best Practices : Jonathan Mills (2:40)
     - [ ] JavaScript Design Patterns : Aaron Powell (2:03)
...
***** Node / Express / Mongo
     ...
     - [X] Securing Your Application with OAuth and Passport (2:23)
